...
public class WeatherTool {
    ...
    @Annotations.Schema(description = "Retrieve current weather of the location")
    public static Map<String, Object> getCurrentWeather(
            @Annotations.Schema(
                    name = "location",
                    description = "Location for which to retrieve current weather"
            ) String location) {
        ...
        try {
            ...
            // ✅ Debug logging — prints JSON result nicely
